...
export AXION_CAMERA_REAR_INFO="50,50,12"
export AXION_CAMERA_FRONT_INFO="32,32"
export AXION_MAINTAINER="xeon_man"
export AXION_PROCESSOR="Snapdragon_8s_Gen_3"
export TARGET_INCLUDE_GOOGLE_TELECOMM=false
export TARGET_INCLUDE_PARTNER_SETUP=true

axion chenfeng user gms;
